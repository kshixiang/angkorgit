...
- **Quality over quantity.** GitMD deliberately implements few features exceptionally well. New feature proposals should explain why the feature is *daily-use* — "GitKraken has it" is not a reason.
